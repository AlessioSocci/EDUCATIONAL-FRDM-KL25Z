...
uint16_t time3 = 10; // threshold of counter in ms
uint16_t time4 = 100; // threshold of counter in ms
...
void task3_incrementCounter(void)
{
   	task3++;
	if (task3 == time3)
	{
...
void task4_incrementCounter(void)
{
   	task4++;
	if (task4 == time4)
	{
...
void PIT_IRQHandler(void)
{
	...
	task3_incrementCounter();
	task4_incrementCounter();
